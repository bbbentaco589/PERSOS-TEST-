...
export function ServiceHomeHero() {
  return (
    <section aria-labelledby="service-home-title" className="overflow-hidden rounded-2xl border border-cyan-300/15 bg-[#03070d] shadow-[0_28px_100px_rgba(0,53,120,0.24)]">
      <div className="relative min-h-[650px] overflow-hidden bg-[#020713] lg:min-h-[520px]">
        <div className="pointer-events-none absolute inset-0">
          <Image
            alt=""
            aria-hidden="true"
            className="scale-110 object-cover object-left opacity-25 blur-[2px] [filter:brightness(.72)_saturate(.9)]"
            fill
            sizes="100vw"
            src="/assets/home/persos-service-hero.png"
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(2,7,19,.88)_0%,rgba(4,16,32,.82)_30%,rgba(2,7,19,.56)_50%,rgba(2,7,19,.2)_100%)]" />
          <div className="absolute inset-0 opacity-30 [background-image:linear-gradient(rgba(56,189,248,.055)_1px,transparent_1px),linear-gradient(90deg,rgba(56,189,248,.045)_1px,transparent_1px)] [background-size:48px_48px]" />
        </div>

        <div className="absolute inset-x-0 top-0 h-[58vw] max-h-[430px] min-h-[280px] lg:bottom-0 lg:left-[33%] lg:right-0 lg:h-auto lg:max-h-none">
          <Image
            ...
            src="/assets/home/persos-service-hero.png"
          />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#020713] lg:bg-[linear-gradient(90deg,#020713_0%,rgba(2,7,19,.7)_6%,rgba(2,7,19,.12)_18%,transparent_36%)]" />
        </div>

        <div className="relative z-10 flex min-h-[650px] max-w-xl flex-col justify-end px-6 pb-10 pt-[58vw] sm:px-10 lg:min-h-[520px] lg:max-w-[36%] lg:justify-center lg:px-12 lg:py-14">
      ...
      <div className="space-y-3 border-t border-blue-300/15 bg-[#030817] p-3 sm:p-4">
        <div className="grid overflow-hidden rounded-2xl border border-blue-300/25 bg-[#040a18] p-2 lg:grid-cols-[13rem_minmax(0,1fr)]">
          <div className="flex items-center justify-between gap-3 px-4 py-3 lg:border-r lg:border-blue-300/15">
            <div>
          ...
          <nav aria-label="페르소스 소개 바로가기" className="grid grid-cols-2 gap-2 lg:pl-2 xl:grid-cols-4">
            {ecosystemNav.map(({ href, icon: Icon, label }) => (
              <Link className="group flex min-h-14 items-center gap-2.5 rounded-xl border border-blue-300/25 bg-[linear-gradient(100deg,rgba(13,31,72,.78),rgba(2,7,19,.94))] px-4 text-xs font-semibold text-zinc-100 transition hover:border-cyan-200/55 hover:bg-blue-400/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-cyan-300" href={href} key={href}>
        ...
        <div className="grid overflow-hidden rounded-2xl border border-blue-300/25 bg-[#040a18] p-2 lg:grid-cols-[13rem_minmax(0,1fr)]">
          ...
          <nav aria-label="페르소나 활동 게시판 바로가기" className="grid grid-cols-2 gap-2 lg:pl-2 xl:grid-cols-4">
