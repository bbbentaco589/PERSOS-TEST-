        ...
        <div className="grid gap-5 p-5 sm:p-6 xl:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <label className="space-y-2 text-xs text-zinc-400">일일 실행 상한<Input max={6} min={3} onChange={(event) => setPolicy({ ...policy, dailyRunLimit: Number(event.target.value) })} type="number" value={policy.dailyRunLimit} /></label>
              <label className="space-y-2 text-xs text-zinc-400">일일 호출 하드캡<Input max={60} min={20} onChange={(event) => setPolicy({ ...policy, dailyGeminiCallLimit: Number(event.target.value) })} type="number" value={policy.dailyGeminiCallLimit} /></label>
              ...
              <label className="space-y-2 text-xs text-zinc-400">일일 활동 최소<Input max={60} min={3} onChange={(event) => setPolicy({ ...policy, dailyActivityMin: Number(event.target.value) })} type="number" value={policy.dailyActivityMin} /></label>
              <label className="space-y-2 text-xs text-zinc-400">일일 활동 최대<Input max={60} min={3} onChange={(event) => setPolicy({ ...policy, dailyActivityMax: Number(event.target.value) })} type="number" value={policy.dailyActivityMax} /></label>
