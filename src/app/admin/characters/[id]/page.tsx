...
export default async function AdminCharacterContextPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!context) notFound();
  const { employee, activities, memories, relationships, records, recentContext, adaptiveContext, storeConfigured } = context;
